    ...
    class SampleProcedualAnimation :  MonoBehaviour
    {
        ...
        public void LateUpdate()
        {
            ...
            for(int i = 0; i < FootTarget.Length; i++)
            {
                ...
                Ray ray = new Ray(foot.transform.position + Vector3.up * 0.5f, Vector3.down);
            ...
            //hand and look
            float normDist = Mathf.Clamp((Vector3.Distance(LookTarget.position, Attraction.position) - 0.3f) / 1f, 0, 1);
